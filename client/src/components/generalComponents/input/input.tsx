...
export default function Label(props:any){
   ...
   return(
      <>
        ...
        <input type={type} name="name" id="name" className="peer border-[#e5eaf2] border rounded-md outline-none px-4 py-3 w-full focus:border-[#3B9DF8] transition-colors duration-300"
        />
