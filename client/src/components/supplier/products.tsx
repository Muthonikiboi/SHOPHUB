  ...
  return (
    <div className="mx-auto p-4 w-full h-full">
      ...
      <div className="mb-4 flex items-center justify-between gap-4">
        ...
        <div className="w-[100%] mb-4 flex items-center justify-between">
                <input
                    placeholder="Search..."
                    value={search}
                ...
                />
                         <button
                            className="px-2 lg:px-4 text-[0.8rem] lg:text-[1.1rem] lg:py-2 bg-blue-700 text-white rounded-xl hover:bg-blue-600">Create New Product
                        </button>
            </div>
